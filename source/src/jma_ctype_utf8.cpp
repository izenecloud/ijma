 ...
 */
void printByte(ostream& stream, unsigned char byte)
{
    stream << hex << showbase << static_cast<unsigned int>(byte) << dec;
}
...
JMA_CType_UTF8* JMA_CType_UTF8::instance()
{
	return new JMA_CType_UTF8;
}
