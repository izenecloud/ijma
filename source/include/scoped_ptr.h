/** \file scopet_ptr.h
 * Definition of class scopet_ptr.
 * 
 * \author Jun Jiang
 * \version 0.1
 * \date Jan 15, 2010
...
#ifndef JMA_SCOPED_PTR_H
#define JMA_SCOPED_PTR_H
...
/**
 * scoped_ptr automatically deletes its binding pointer in its destructor.
 * \tparam T the type it points to
 */
