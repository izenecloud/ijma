...
ifeq (,$(findstring C:\Program Files (x86)\Microsoft Visual Studio 8\VC\ATLMFC\LIB;C:\Program Files (x86)\Microsoft Visual Studio 8\VC\LIB;C:\Program Files (x86)\Microsoft Visual Studio 8\VC\PlatformSDK\lib;C:\Program Files (x86)\Microsoft Visual Studio 8\SDK\v2.0\lib,$(LIB)))
ENVIRONMENT_ERROR=true
endif
ifeq (,$(findstring C:\Program Files (x86)\Microsoft Visual Studio 8\VC\ATLMFC\LIB,$(LIBPATH)))
ENVIRONMENT_ERROR=true
endif
...
ifdef DEBUG
    ...
    EXE_COM_FLAGS = /SUBSYSTEM:WINDOWS /DLL /INCREMENTAL /MANIFEST /MACHINE:X86 /ERRORREPORT:PROMPT \
                    ...
                    comdlg32.lib advapi32.lib shell32.lib ole32.lib       \
                    oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib netapi32.lib
    EXE_DLL_FLAGS = /DLL /INCREMENTAL:NO /MACHINE:X86 \
                    kernel32.lib user32.lib gdi32.lib winspool.lib  \
                    comdlg32.lib advapi32.lib shell32.lib ole32.lib \
