...
CC_PROG      = aCC
ifdef DEBUG
    CC_FLAGS = -c -g -AA -mt +DA2.0W +W829,921 -DARCH64 -DHPUX -DDEBUG
else
    CC_FLAGS = -c +O2 -AA -mt +DA2.0W +W829,921 -DARCH64 -DHPUX
endif # DEBUG
CC_LIB_FLAGS =
CC_CON_FLAGS =
CC_DLL_FLAGS = +Z
...
############################################################
EXE_PROG      = aCC
EXE_FLAGS     = -AA -Wl,+s,+b,../lib -lm +DA2.0W
EXE_CON_FLAGS = 
EXE_DLL_FLAGS = -b
EXE_DLL_EXT   = sl
